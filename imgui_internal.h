...
struct IMGUI_API ImGuiWindow
{
    ...
    ImVec2                  ScrollAnimTarget;                   // persistent wheel-scroll target used for native smooth scrolling
    ImVec2                  ScrollAnimVelocity;                 // critically damped wheel-scroll velocity
    ImVec2                  ScrollAnimLastApplied;              // last scroll value written by the smooth scroll path
    ImU8                    ScrollAnimMask;                     // bitmask of axes currently animated by wheel smoothing
