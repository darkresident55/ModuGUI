...
- Adjustments for integration with ModuGUI (engine-facing UI layer)

This is **not a drop-in replacement for upstream Dear ImGui** and may diverge from the original project.
